...
```
mavencentral <command> [arguments] [flags]
```

Run `mavencentral <command> --help` for the full flag list on any command. This
...
per operation you declare in `mavencentral/domain.go`.
